...
export default function DonutChart() {
		...
		const MedicinePercent = async () => {
			try {
				const response = await axios.get(
					"http://13.209.29.41:8080/api/medicine-check/intake-rate",
					{
						headers: {
	...
	const data = {
		...
		datasets: [
			// 데이터 관련 정보(값, 컬러, 라벨 등)를 담은 dataset 객체들을 가지고 있는 배열
			{
	...
	// 렌더링값
	return (
		<div className='chartContainer w-[320px] h-[400px]'>
			{" "}
			{/* 여기서 차트 크기 조정  */}
