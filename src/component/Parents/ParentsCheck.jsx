...
const ParentsCheck = () => {
	...
	return (
		<div className='flex flex-col items-center'>
			<div className='w-[70%] flex justify-center items-center bg-[#E9F4FD] border-[2px] border-[#ABD8F7] rounded-[10px] drop-shadow-md px-[50px] py-[30px] mb-[10px]'>
			...
			<div className='w-[90%] grid grid-cols-4 place-items-center rounded-[10px py-[20px] px-[50px] mt-[20px] rounded-[10px]'>
				...
				<div className='flex flex-col items-center mx-[20px]'>
					...
					<div className='bg-white px-[20px] py-[20px] rounded-[15px] drop-shadow-md'>
						<img
							className='w-[180px] px-[20px] pb-[20px]'
							src='img/sleep.png'
							alt=''
						/>
